...
const path = `C:\\Program Files\\BraveSoftware\\Brave-Browser\\Application\\brave.exe`;
const dir = `C:\\Users\\trant\\AppData\\Local\\BraveSoftware\\Brave-Browser\\User Data`;
const profile = "Default";

const cakeName = `Plaster`;
const cookingTime = 2; // 4m

const loop = 5; // 4 stove = 2 loop ex: 10 stove -> loop = 5
const minEnToDink = 400;
const minEnStopCooking = 30;
...
(async () => {
    ...
    const stove1 = { x: 324, y: 268 };
    const stove2 = { x: 459, y: 337 };
    const self = { x: 273, y: 407 };
